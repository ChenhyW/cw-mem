...
const DEFAULT_CONFIG = {
  ...
  recall: {
    topK: 20,                     // KNN 召回候选数
    minScore: 0.30,               // 注入阈值: sim = 1/(1+L2)。归一化向量下 sim ∈ [0.4142, 1.0],
                                  // 所以 0.30 低于下界 = 事实上不过滤(等同 top-K 全收)。
                                  // 0.5↔cos0.50, 0.6↔cos0.778, 0.7↔cos0.908(小模型通常达不到)。
                                  // 换算与实测依据见 lib/vector.js 顶部。
