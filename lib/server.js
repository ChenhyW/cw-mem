  ...
  return new Promise((resolve, reject) => {
    ...
    function handlePrompt(data) {
      ...
      const result = db.prepare(
        'INSERT INTO prompts (session_id, prompt, type, tool_name, project_dir, claude_prompt_id, tool_target, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?)'
      ).run(data.sessionId || 'unknown', data.prompt || '', type, toolName, data.projectDir || null, claudePromptId, toolTarget, nowIso());
